...
include_once "../admin/update_last_activity.php";
...
<nav class="navbar navbar-expand-sm navbar-dark-50 fixed-top" style="background-color: #00838f;">
    <ul class="item-nav navbar-nav  mr-auto">
        ...
        <li class="nav-item">
            ...
            <a class="nav-link" href="../admin/logout.php" name="logout">Log out</a>
        </li>
    </ul>
</nav>
...
<section>
    ...
    <div class="container emp-profile cont-task" id="user_details">
        <form method="GET" action="process.php">
            ...
            $time=time();
            $id=$_GET['id'];
            $sql="select * from login where id_credential!='$id' ORDER BY last_login DESC ";
            $params = array();
...
<script>
    $(document).ready(function(){
        ...
        {
            $.ajax({
                url:"../admin/update_last_activity.php",
                success:function()
                {
